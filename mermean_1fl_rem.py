...
if __name__ == '__main__': 
    ...
    WEXPs = [G7W0,G7W05,G7W1,G6W0,G6W05,G6W1]
    OEXPs = ['h1000a20_2D','h2000a20_2D','h3000a20_2D']
    #WEXPs = [G6W0, G6W05]
    SMEXPs = ['40_homo','80_homo']

    for WEXP in WEXPs:
        for OEXP in OEXPs:
            for SMEXP in SMEXPs:#OEXP = 'h1000a20_2D'
                #SMEXP = '60_homo'
